    ...
    return (
        <div className="py-12 bg-[#0784C2]">
            ...
            <div className="flex gap-y-16 flex-col  md:flex-row items-center justify-center md:space-x-8 p-8">
                {/* Card 1 */}
                <div className="custom-card py-5 relative h-60 bg-[#404F9A]">
                ...
                {/* Card 2 */}
                <div className="custom-card  relative h-60  bg-[#404F9A]">
            ...
            <div className='text-center pt-2'>
                <button className="bg-[#CC009C] text-white font-serif font-semibold py-3 px-6 rounded-full shadow-md transition duration-300 transform hover:scale-105">
                    Start your business
                </button>
            </div>
        </div>

    ...
    <div className="bg-orange-100 py-20">
      ...
      <section className="">
        <div className="flex items-center justify-center mb-10">
          <button onClick={() => setShowFeedbackForm(true)} className="btn btn-primary "> feedback</button>
        </div>
        {/* Feedback Form */}
        {showFeedbackForm && (
            ...
            <form onSubmit={handleFeedbackSubmit} className="w-full max-w-md">
              <div className="grid grid-cols-2 gap-5">
                <div className="mb-4">
                  ...
                  <input required type="text" id="name" name="name" className="mt-1 p-2 w-full rounded border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200" placeholder="Your Name" />
                </div>
                <div className="mb-4">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700"> Email </label>
                  <input required type="email" id="email" name="email" className="mt-1 p-2 w-full rounded border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200" placeholder="Your Email" />
                </div>
              </div>
              <div className="mb-4">
                <Rating
              ...
              <button type="submit" className="btn btn-primary py-2 px-4 bg-indigo-500 text-white font-semibold rounded hover:bg-indigo-600 focus:outline-none focus:ring focus:ring-indigo-200" >
                Submit Feedback
              </button>
            </form>
